Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=username", "Value=ben", ENDITEM, 
		"Name=password", "Value=bob", ENDITEM, 
		"Name=passwordConfirm", "Value=bob", ENDITEM, 
		"Name=firstName", "Value=Ben", ENDITEM, 
		"Name=lastName", "Value=Bob", ENDITEM, 
