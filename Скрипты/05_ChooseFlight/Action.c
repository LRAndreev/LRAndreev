Action()
{
	...
	lr_start_transaction("loadWebTours");
		...
		Original value='129608.073795059zzzzHVfpcQfiDDDDtAAAApcQVHHf' 
		Name ='userSession' 
		Type ='Rule' 
		AppName ='WebTours' 
	...
	lr_start_transaction("find_flight_continue");
		...
		/*Correlation comment: Automatic rules - Do not change!  
		Original value='011;644;09/14/2020' 
		Name ='outboundFlight' 
		Type ='Rule' 
		AppName ='WebTours' 
		...
		/*Correlation comment - Do not change!  Original value='103;592;09/21/2020' Name ='returnFlight' Type ='ResponseBased'*/
	web_reg_save_param_attrib(
	...
	lr_end_transaction("05_ChooseFlight", LR_AUTO);
